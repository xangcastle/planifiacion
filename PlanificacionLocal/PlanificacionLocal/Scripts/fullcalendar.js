...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		return '<a class="' + classes.join(' ') + '" title="Dar click para visualizar en detalle la actividad, o mantener presionado el mouse sobre la actividad y moverlo a otra fecha para modificar"' +
				(event.url ?
	...
	numberCellHtml: function(cell) {
		...
		return '' +
			'<td class="' + classes.join(' ') + '" data-date="' + date.format() + '">' +
				date.date() + '<input type="checkbox" id="All" name="' + "NM" + date.format('MMMM YYYY') + '" class="ocultar" title="Checkear el checkbox para seleccionar la fecha para la actividad" data-FechR="' + date.format('DD/MM/YYYY') + '" value="' + date.format('DD/MM/YYYY') + '">'
            + '</td>';
	},
